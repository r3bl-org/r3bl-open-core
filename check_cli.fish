...
function show_help
    ...
    echo "FEATURES:"
    set_color normal
    echo "  ✓ Zombie process purging (kills project-related parents of leaked zombies)"
    ...
    echo "  • Output logged to $CHECK_LOG_FILE for debugging"
    echo ""
    ...
    echo "  3. Compare with stored hash in $CHECK_BUILD_CONFIG_HASH_FILE"
    echo "  4. If different: clean $CHECK_TARGET_DIR, store new hash, rebuild"
    ...
    echo "     • One-off --doc:  cargo doc (full, deps cached when unchanged)"
    ...
    echo ""
    echo "  1. tmpfs Build Directory ($CHECK_TARGET_DIR):"
    ...
    echo "    🚀 Running checks..."
    echo ""
    echo "    [03:41:57 PM] 🛫 Running tests..."
    echo "    [03:42:01 PM] ✅ tests passed (3s)"
    echo ""
    echo "    [03:42:01 PM] 🛫 Running doctests..."
    echo "    [03:42:06 PM] ✅ doctests passed (5s)"
    echo ""
    echo "    [03:42:06 PM] 🛫 Running docs..."
