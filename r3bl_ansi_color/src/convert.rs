...
pub fn convert_rgb_into_ansi256(rgb_color: RgbColor) -> Ansi256Color {
    ...
    match approximate_difference_to_cube_mapped_color.cmp(&approximate_difference_to_grayscale) {
        Less => Ansi256Color {
...
mod cube_mapping {
    ...
    pub fn calculate_cube_mapping_for_rgb_color(rgb_color: RgbColor) -> CubeMappingResult {
        ...
        let cube_ansi256_index =
            red_result.ansi256_index + green_result.ansi256_index + blue_result.ansi256_index;
    ...
    pub fn calculate_relative_diff_between_colors(this: RgbColor, other: RgbColor) -> u32 {
        let RgbColor {
            red: this_red,
            green: this_green,
            blue: this_blue,
...
pub mod constants {
    ...
    pub static ANSI256_FROM_GRAY: [u8; 256] = [
        16, 16, 16, 16, 16, 232, 232, 232, 232, 232, 232, 232, 232, 232, 233, 233, 233, 233, 233,
        233, 233, 233, 233, 233, 234, 234, 234, 234, 234, 234, 234, 234, 234, 234, 235, 235, 235,
        235, 235, 235, 235, 235, 235, 235, 236, 236, 236, 236, 236, 236, 236, 236, 236, 236, 237,
        237, 237, 237, 237, 237, 237, 237, 237, 237, 238, 238, 238, 238, 238, 238, 238, 238, 238,
        238, 239, 239, 239, 239, 239, 239, 239, 239, 239, 239, 240, 240, 240, 240, 240, 240, 240,
        240, 59, 59, 59, 59, 59, 241, 241, 241, 241, 241, 241, 241, 242, 242, 242, 242, 242, 242,
        242, 242, 242, 242, 243, 243, 243, 243, 243, 243, 243, 243, 243, 244, 244, 244, 244, 244,
        244, 244, 244, 244, 102, 102, 102, 102, 102, 245, 245, 245, 245, 245, 245, 246, 246, 246,
        246, 246, 246, 246, 246, 246, 246, 247, 247, 247, 247, 247, 247, 247, 247, 247, 247, 248,
        248, 248, 248, 248, 248, 248, 248, 248, 145, 145, 145, 145, 145, 249, 249, 249, 249, 249,
        249, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 251, 251, 251, 251, 251, 251, 251,
        251, 251, 251, 252, 252, 252, 252, 252, 252, 252, 252, 252, 188, 188, 188, 188, 188, 253,
        253, 253, 253, 253, 253, 254, 254, 254, 254, 254, 254, 254, 254, 254, 254, 255, 255, 255,
        255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 231, 231, 231, 231, 231, 231, 231,
        231, 231,
    ];
