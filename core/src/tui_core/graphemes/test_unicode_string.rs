...
mod tests {
    ...
    fn test_unicode_string_logical_index_tofro_display_col() {
        ...
        assert_eq2!(u_s.at_display_col_index(00.into()).unwrap().string, "H");
        assert_eq2!(u_s.at_display_col_index(01.into()).unwrap().string, "i");
        assert_eq2!(u_s.at_display_col_index(02.into()).unwrap().string, " ");
        assert_eq2!(u_s.at_display_col_index(03.into()).unwrap().string, "😃");
        assert_eq2!(u_s.at_display_col_index(04.into()).unwrap().string, "😃");
        assert_eq2!(u_s.at_display_col_index(05.into()).unwrap().string, " ");
        assert_eq2!(u_s.at_display_col_index(06.into()).unwrap().string, "📦");
        assert_eq2!(u_s.at_display_col_index(07.into()).unwrap().string, "📦");
