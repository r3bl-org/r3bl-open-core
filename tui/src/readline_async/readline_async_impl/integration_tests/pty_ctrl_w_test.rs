...
//! processing all available input, not after every character. Otherwise, controller will
//! read intermediate states (e.g., "Line: h, Cursor: 1" instead of "Line: hello world,
//! Cursor: 11").
//!
...
//!
//! ```bash
//! cargo test -p r3bl_tui --lib test_pty_ctrl_w_deletion -- --nocapture
//! ```
//!
...
use crate::{AsyncDebouncedDeadline, CONTROLLED_READY, CONTROLLED_STARTING,
            ...
            TEST_RUNNING, core::test_fixtures::StdoutMock, generate_pty_test,
...
fn pty_controller_entry_point(context: PtyTestContext) {
    ...
    eprintln!("📝 PTY Controller: Test 1 - Delete word with space boundary...");
    ...
    eprintln!("📝 PTY Controller: Test 2 - Delete word with punctuation boundary...");
...
fn pty_controlled_entry_point() {
    ...
    runtime.block_on(async {
        ...
        // "Do X after Y ms of no activity" This batches rapid input (e.g., "one two
        // three" arrives as 13 chars within ~1-2ms, all processed before first print at
        // ~12ms)
