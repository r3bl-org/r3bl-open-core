...
use crate::ansi_parser::term_units::term_row;
...
pub mod decstbm_margins {
    ...
    fn test_set_margins_valid_range() {
        ...
        let csi_sequence = format!("{}", CsiSequence::SetScrollingMargins {
            top: Some(term_row(3)),
    ...
    fn test_margin_edge_cases() {
        ...
        let full_buffer = format!("{}", CsiSequence::SetScrollingMargins {
            top: Some(term_row(1)),
        ...
        let invalid_range = format!("{}", CsiSequence::SetScrollingMargins {
            top: Some(term_row(7)),
        ...
        let reset = format!("{}", CsiSequence::SetScrollingMargins {
            top: None,
            bottom: None
        });
