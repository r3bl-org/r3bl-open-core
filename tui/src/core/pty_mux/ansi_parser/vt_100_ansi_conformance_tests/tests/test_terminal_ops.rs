...
use crate::{ansi_parser::protocols::esc_codes::EscSequence,
            TuiStyle, Pos, CharacterSet, ch, RowIndex, ColIndex};
...
pub mod reset_initial_state {
    ...
    fn test_ris_resets_style() {
        ...
        assert_eq!(ofs_buf.ansi_parser_support.current_style, TuiStyle::default());
    }
...
pub mod character_set_selection {
    ...
    fn test_select_dec_graphics_character_set() {
        ...
        assert_eq!(ofs_buf.ansi_parser_support.character_set, CharacterSet::DECGraphics);
    }
