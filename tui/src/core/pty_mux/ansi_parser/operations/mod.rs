...
//!
//! - Each operation module acts as a parameter translator from ANSI sequences to [`OffscreenBuffer`] calls
//! - Operations contain minimal logic, primarily focused on parameter parsing and delegation
//! - All actual terminal buffer logic is implemented in dedicated [`OffscreenBuffer`] methods
//! - This design ensures a clear separation between ANSI protocol handling and buffer operations
//!
//! This consistent pattern across all operation modules makes the codebase predictable and
//! maintainable, with clear boundaries between protocol translation and buffer management.
//!
//! # Testing Strategy
//!
...
//! 4. The VT100 conformance tests in [`vt_100_ansi_conformance_tests`] verify the complete ANSI processing pipeline
//!
