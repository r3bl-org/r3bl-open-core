    ...
    fn csi_dispatch(
        ...
        match dispatch_char {
            ...
            'I' => {
                ...
                // See [mod-level docs](crate::vt100_ansi_parser) for rationale
            ...
            'g' => {
                ...
                // own. See [mod-level docs](crate::vt100_ansi_parser) for rationale
            ...
            'c' => {
                ...
                // does. See [mod-level docs](crate::vt100_ansi_parser) for rationale
                tracing::warn!(
