...
//!
//! [`esc_codes`]: crate::vt100_ansi_parser::esc_codes
//!
//! ## Structure
...
pub mod csi_test_helpers {
    ...
    /// # Examples
    /// ```
    /// use r3bl_tui::vt100_ansi_parser::csi_codes::csi_test_helpers::csi_seq_cursor_pos;
    ...
    /// # Examples
    /// ```
    /// use r3bl_tui::vt100_ansi_parser::csi_codes::csi_test_helpers::csi_seq_cursor_pos_alt;
    /// use r3bl_tui::vt100_ansi_parser::term_units::{term_row, term_col};
    ///
    /// // Instead of:
