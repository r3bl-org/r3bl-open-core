...
use crate::vt100_ansi_parser::term_units::{term_col, term_row};
...
pub mod basic_tab_operations {
    ...
    fn test_tab_from_mid_column() {
        ...
        let move_sequence = format!(
            "{}",
            crate::vt100_ansi_parser::protocols::csi_codes::CsiSequence::CursorPosition {
                row: term_row(1),
...
pub mod tab_edge_cases {
    ...
    fn test_tab_with_line_wrapping_disabled() {
        ...
        let disable_wrap = format!(
            "{}",
            crate::vt100_ansi_parser::protocols::csi_codes::CsiSequence::DisablePrivateMode(
                crate::vt100_ansi_parser::protocols::csi_codes::PrivateModeType::AutoWrap
            )
        );
