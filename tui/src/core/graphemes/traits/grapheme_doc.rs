...
pub trait GraphemeDoc {
    ...
    /// Gets the entire document as bytes.
...
pub trait GraphemeDocMut: GraphemeDoc {
    ...
    /// Deletes a range of graphemes from a line.
    ///
    /// # Errors
    ///
    /// Returns an error if:
    ...
    /// Inserts an empty line at the specified row.
    ///
    /// # Errors
    ///
    ...
    /// Merges the line at row with the next line.
    ///
    /// # Errors
    ///
    /// Returns an error if:
