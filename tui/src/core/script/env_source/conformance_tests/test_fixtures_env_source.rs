...
//! Test harness scaffolding and mock environment builders for `env-source` conformance tests.
...
/// Generates a deterministic mock initial environment for Windows with an existing variable
/// to be removed or unset.
#[must_use]
...
/// # Errors
///
/// Returns an error if creating the temporary directory or evaluating the shell script fails.
///
/// # Panics
///
