...
///    [`EnvDiff::compute`] and [`is_filtered_variable`]).
...
/// [`EnvDiff::compute`]: crate::EnvDiff::compute
/// [`EnvDiff::serialize_to_string`]: crate::EnvDiff::serialize_to_string
/// [`EnvMap`]: crate::EnvMap
...
pub fn try_env_source(
    ...
    let diff = EnvDiff::compute(initial_env, mutated_env);

    let formatted_output = diff.serialize_to_string(output_format);
