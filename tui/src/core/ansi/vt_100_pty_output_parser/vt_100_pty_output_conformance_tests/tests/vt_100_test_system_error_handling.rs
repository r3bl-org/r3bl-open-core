...
//!
//! This module tests the parser's ability to handle malformed sequences, invalid
//! parameters, incomplete sequences, and other error conditions gracefully without
//! crashing or corrupting state.
//!
//! ## Raw Byte Sequences Usage
//!
//! **Important**: This test module intentionally uses raw byte sequences (e.g.,
//! `b"\x1b[L"`) instead of our type-safe builders ([`CsiSequence`], [`EscSequence`],
//! etc.) because:
//!
...
//!
//! This is the **only** test module where raw sequences are appropriate. All other tests
//! should use the type-safe builders for maintainability and correctness.
//!
...
pub mod malformed_osc_sequences {
    ...
    fn test_osc_with_malformed_parameters() {
        ...
        let malformed_hyperlinks: Vec<&[u8]> = vec![
            ...
            b"\x1b]8;invalid-param;https://example.com\x07", // Malformed parameters
        ];
