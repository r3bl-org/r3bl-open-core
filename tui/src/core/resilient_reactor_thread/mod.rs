...
//!    to declare your own `static` singleton (initialized with a [`const expression`]):
//!
//!    <!-- It is ok to use ignore here - example of static singleton declaration -->
//!
//!    ```ignore
//!    /// From mio_poller implementation:
//!    static SINGLETON: ThreadSafeGlobalState<
//!        MioPollWaker, /* W: ThreadWaker */
//!        PollerEvent   /* E: Clone + Send + 'static */
