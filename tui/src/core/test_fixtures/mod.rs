...
//! # use r3bl_tui::core::test_fixtures::gen_input_stream;
...
//! # use futures_util::StreamExt;
//! # use r3bl_tui::core::test_fixtures::gen_input_stream_with_delay;
//! # use smallvec::smallvec;
//!
//! #[tokio::test]
...
//!
//!     let mut input_stream = gen_input_stream_with_delay(
//!         smallvec![1, 2, 3],
