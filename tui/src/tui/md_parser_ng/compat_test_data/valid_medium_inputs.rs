...
pub const NESTED_UNORDERED_LIST: &str = "- Top level\n  - Nested item\n    - Deep nested\n- Back to top";
pub const NESTED_ORDERED_LIST: &str = "1. First\n  2. Nested second\n     Content\n    3. Nested third\n2. Second top";
pub const CHECKBOXES: &str = "- [ ] Unchecked\n- [x] Checked\n- [X] Also checked";
pub const MIXED_LIST_TYPES: &str = "- Unordered item\n1. Ordered item\n- [ ] Checkbox item\n2. Another ordered";

// Code blocks
pub const CODE_BLOCK_BASH: &str = "```bash\necho \"Hello World\"\nls -la\n```";
pub const CODE_BLOCK_RUST: &str = "```rust\nfn main() {\n    println!(\"Hello, world!\");\n}\n```";
pub const CODE_BLOCK_NO_LANGUAGE: &str = "```\nSome code\nwithout language\n```";
pub const EMPTY_CODE_BLOCK: &str = "```rust\n```";

// Formatting patterns
pub const FORMATTING_EDGE_CASES: &str = "*start bold*\n_start italic_\n`start code`\nend *bold*\nend _italic_\nend `code`";
pub const NESTED_FORMATTING: &str = "This is *bold with `code` inside*\nThis is _italic with `code` inside_";

// Edge cases
pub const EDGE_CASE_EMPTY_LINES: &str = "Line 1\n\n\nLine 2\n\n";
pub const EDGE_CASE_WHITESPACE_LINES: &str = "Line 1\n   \n\t\nLine 2";
pub const EDGE_CASE_TRAILING_SPACES: &str = "Line with trailing spaces   \nAnother line  ";

// Emoji positioning
pub const EMOJI_START_MIDDLE_END: &str = "# 😀 Emoji at start\n## Middle 😀 emoji\n### Emoji at end 😀";
