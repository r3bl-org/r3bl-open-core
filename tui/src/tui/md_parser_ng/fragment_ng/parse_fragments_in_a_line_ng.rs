...
use super::{parse_fragment_plain_text_until_eol_or_eoi_ng,
            parse_fragment_starts_with_backtick_err_on_new_line_ng,
            parse_fragment_starts_with_checkbox_checkbox_into_bool_ng,
            parse_fragment_starts_with_checkbox_into_str_ng,
            parse_fragment_starts_with_left_image_err_on_new_line_ng,
...
/// functions like [`crate::standard_ng::parse_line_text_advance_ng()`]:
///
/// ```txt
...
pub fn parse_inline_fragments_until_eol_or_eoi_ng(
    ...
    let it = match checkbox_policy {
        CheckboxParsePolicy::IgnoreCheckbox => alt((
            map(parse_fragment_starts_with_underscore_err_on_new_line_ng,  |s| MdLineFragment::Italic(s.extract_to_line_end())),
            map(parse_fragment_starts_with_star_err_on_new_line_ng,        |s| MdLineFragment::Bold(s.extract_to_line_end())),
            map(parse_fragment_starts_with_backtick_err_on_new_line_ng,    |s| MdLineFragment::InlineCode(s.extract_to_line_end())),
            map(parse_fragment_starts_with_left_image_err_on_new_line_ng,  MdLineFragment::Image),
            map(parse_fragment_starts_with_left_link_err_on_new_line_ng,   MdLineFragment::Link),
            map(parse_fragment_starts_with_checkbox_into_str_ng,           |s| MdLineFragment::Plain(s.extract_to_line_end())), // This line is different.
            map(parse_fragment_plain_text_until_eol_or_eoi_ng,                  |s| MdLineFragment::Plain(s.extract_to_line_end())),
        ...
        CheckboxParsePolicy::ParseCheckbox => alt((
            ...
            map(parse_fragment_starts_with_left_image_err_on_new_line_ng,  MdLineFragment::Image),
            map(parse_fragment_starts_with_left_link_err_on_new_line_ng,   MdLineFragment::Link),
            map(parse_fragment_starts_with_checkbox_checkbox_into_bool_ng, MdLineFragment::Checkbox), // This line is different.
            map(parse_fragment_plain_text_until_eol_or_eoi_ng,                 |s| MdLineFragment::Plain(s.extract_to_line_end())),
        )).parse(input_clone)
    };
