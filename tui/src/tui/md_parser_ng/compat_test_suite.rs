...
mod tests_parse_markdown_compatibility {
    ...
    fn test_malformed_syntax() {
        test_compatibility_helper("malformed_syntax", MALFORMED_SYNTAX);
    }

    #[test]
    fn test_unclosed_formatting() {
        test_compatibility_helper("unclosed_formatting", UNCLOSED_FORMATTING);
    }
    ...
    #[test]
    fn test_empty_string() { test_compatibility_helper("empty_string", EMPTY_STRING); }

    #[test]
    fn test_only_newlines() { test_compatibility_helper("only_newlines", ONLY_NEWLINES); }

    #[test]
    fn test_single_line_no_newline() {
        test_compatibility_helper("single_line_no_newline", SINGLE_LINE_NO_NEWLINE);
    }

    #[test]
    fn test_single_line_with_newline() {
        test_compatibility_helper("single_line_with_newline", SINGLE_LINE_WITH_NEWLINE);
    }

    #[test]
    fn test_simple_inline_code() {
        test_compatibility_helper("simple_inline_code", SIMPLE_INLINE_CODE);
    }

    #[test]
    fn test_inline_code_variations() {
        test_compatibility_helper("inline_code_variations", INLINE_CODE_VARIATIONS);
    }

    #[test]
    fn test_inline_code_with_unicode() {
        test_compatibility_helper("inline_code_with_unicode", INLINE_CODE_WITH_UNICODE);
    }

    #[test]
    fn test_bold_text() { test_compatibility_helper("bold_text", BOLD_TEXT); }

    #[test]
    fn test_italic_text() { test_compatibility_helper("italic_text", ITALIC_TEXT); }

    #[test]
    fn test_mixed_formatting() {
        test_compatibility_helper("mixed_formatting", MIXED_FORMATTING);
    }

    #[test]
    fn test_links() { test_compatibility_helper("links", LINKS); }

    #[test]
    fn test_images() { test_compatibility_helper("images", IMAGES); }

    #[test]
    fn test_metadata_title() {
        test_compatibility_helper("metadata_title", METADATA_TITLE);
    }

    #[test]
    fn test_metadata_tags() { test_compatibility_helper("metadata_tags", METADATA_TAGS); }

    #[test]
    fn test_metadata_authors() {
        test_compatibility_helper("metadata_authors", METADATA_AUTHORS);
    }

    #[test]
    fn test_metadata_date() { test_compatibility_helper("metadata_date", METADATA_DATE); }

    #[test]
    fn test_special_characters() {
        test_compatibility_helper("special_characters", SPECIAL_CHARACTERS);
    }

    #[test]
    fn test_unicode_content() {
        test_compatibility_helper("unicode_content", UNICODE_CONTENT);
    }
    ...
    fn test_multiple_lines() {
        test_compatibility_helper("multiple_lines", MULTIPLE_LINES);
    }

    #[test]
    fn test_heading_basic() { test_compatibility_helper("heading_basic", HEADING_BASIC); }

    #[test]
    fn test_multiple_headings() {
        test_compatibility_helper("multiple_headings", MULTIPLE_HEADINGS);
    }

    #[test]
    fn test_all_heading_levels() {
        test_compatibility_helper("all_heading_levels", ALL_HEADING_LEVELS);
    }

    #[test]
    fn test_unordered_list_simple() {
        test_compatibility_helper("unordered_list_simple", UNORDERED_LIST_SIMPLE);
    }

    #[test]
    fn test_ordered_list_simple() {
        test_compatibility_helper("ordered_list_simple", ORDERED_LIST_SIMPLE);
    }

    #[test]
    fn test_nested_unordered_list() {
        test_compatibility_helper("nested_unordered_list", NESTED_UNORDERED_LIST);
    }

    #[test]
    fn test_nested_ordered_list() {
        test_compatibility_helper("nested_ordered_list", NESTED_ORDERED_LIST);
    }

    #[test]
    fn test_checkboxes() { test_compatibility_helper("checkboxes", CHECKBOXES); }

    #[test]
    fn test_mixed_list_types() {
        test_compatibility_helper("mixed_list_types", MIXED_LIST_TYPES);
    }

    #[test]
    fn test_code_block_bash() {
        test_compatibility_helper("code_block_bash", CODE_BLOCK_BASH);
    }

    #[test]
    fn test_code_block_rust() {
        test_compatibility_helper("code_block_rust", CODE_BLOCK_RUST);
    }

    #[test]
    fn test_code_block_no_language() {
        test_compatibility_helper("code_block_no_language", CODE_BLOCK_NO_LANGUAGE);
    }

    #[test]
    fn test_empty_code_block() {
        test_compatibility_helper("empty_code_block", EMPTY_CODE_BLOCK);
    }

    #[test]
    fn test_formatting_edge_cases() {
        test_compatibility_helper("formatting_edge_cases", FORMATTING_EDGE_CASES);
    }

    #[test]
    fn test_nested_formatting() {
        test_compatibility_helper("nested_formatting", NESTED_FORMATTING);
    }

    #[test]
    fn test_edge_case_empty_lines() {
        test_compatibility_helper("edge_case_empty_lines", EDGE_CASE_EMPTY_LINES);
    }
    ...
    fn test_edge_case_trailing_spaces() {
        test_compatibility_helper("edge_case_trailing_spaces", EDGE_CASE_TRAILING_SPACES);
    }

    #[test]
    fn test_emoji_start_middle_end() {
        test_compatibility_helper("emoji_start_middle_end", EMOJI_START_MIDDLE_END);
    }
    ...
    fn test_blog_post_document() {
        test_compatibility_helper("blog_post_document", BLOG_POST_DOCUMENT);
    }

    #[test]
    fn test_complex_nested_document() {
        test_compatibility_helper("complex_nested_document", COMPLEX_NESTED_DOCUMENT);
    }

    #[test]
    fn test_tutorial_document() {
        test_compatibility_helper("tutorial_document", TUTORIAL_DOCUMENT);
    }
    ...
    fn test_real_world_editor_content() {
        test_compatibility_helper("real_world_editor_content", REAL_WORLD_EDITOR_CONTENT);
    }
...
3. Back to ordered"#;
        test_compatibility_helper("complex_list_with_content", complex_list_input);
    }
...
2. Run the tool:
   ...
   my-tool --help
   ```"#;
        test_compatibility_helper("code_blocks_in_lists", code_blocks_in_lists_input);
    }
...
- ![Image link](https://example.com/image.png "Alt text")"#;
        test_compatibility_helper("complex_links", complex_links_input);
    }
    ...
    fn test_emoji_in_headings() {
        ...
        test_compatibility_helper("emoji_h1_simple", EMOJI_H1_SIMPLE);

        // Test emoji in H2 heading
        test_compatibility_helper("emoji_h2_simple", EMOJI_H2_SIMPLE);

        // Test multiple emojis in heading
        test_compatibility_helper("emoji_multiple", EMOJI_MULTIPLE);
    }
