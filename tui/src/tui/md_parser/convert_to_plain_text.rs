...
use crate::{convert_to_string_slice, get_hashes, get_hlines, get_spaces, inline_string,
            join, join_fmt, join_with_index,
            md_parser::constants::{BACK_TICK, CHECKED, LEFT_BRACKET,
            ...
            usize_to_u8_array, HeadingLevel, HyperlinkData, InlineString, List,
...
pub fn generate_unordered_list_item_bullet(
    ...
    if *is_first_line {
        acc.push_str(get_hlines(*indent));
