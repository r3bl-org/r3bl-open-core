...
pub fn parse_fragment_starts_with_underscore_err_on_new_line<'a>(
    input: AsStrSlice<'a>,
...
pub fn parse_fragment_starts_with_star_err_on_new_line<'a>(
    input: AsStrSlice<'a>,
) -> IResult<AsStrSlice<'a>, AsStrSlice<'a>> {
    specialized_parser_delim_matchers::take_starts_with_delim_no_new_line(input, STAR)
}

pub fn parse_fragment_starts_with_backtick_err_on_new_line<'a>(
    input: AsStrSlice<'a>,
) -> IResult<AsStrSlice<'a>, AsStrSlice<'a>> {
...
pub fn parse_fragment_starts_with_left_image_err_on_new_line<'a>(
    input: AsStrSlice<'a>,
...
pub fn parse_fragment_starts_with_left_link_err_on_new_line<'a>(
    input: AsStrSlice<'a>,
) -> IResult<AsStrSlice<'a>, HyperlinkData<'a>> {
...
pub fn parse_fragment_starts_with_checkbox_into_str<'a>(
    input: AsStrSlice<'a>,
) -> IResult<AsStrSlice<'a>, AsStrSlice<'a>> {
...
/// So some extra hint is need from the code calling this parser to let it know whether to
/// parse a checkbox into plain text, or into a boolean.
pub fn parse_fragment_starts_with_checkbox_checkbox_into_bool<'a>(
    input: AsStrSlice<'a>,
