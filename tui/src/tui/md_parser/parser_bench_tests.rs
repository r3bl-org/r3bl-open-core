...
mod benchmarks {
    ...
    fn bench_small_empty_string(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(EMPTY_STRING);
        });
    }
    ...
    fn bench_small_only_newlines(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(ONLY_NEWLINES);
        });
    }
    ...
    fn bench_small_single_line_no_newline(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(SINGLE_LINE_NO_NEWLINE);
        });
    }
    ...
    fn bench_small_single_line_with_newline(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(SINGLE_LINE_WITH_NEWLINE);
        });
    }
    ...
    fn bench_small_bold_text(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(BOLD_TEXT);
        });
    }
    ...
    fn bench_small_italic_text(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(ITALIC_TEXT);
        });
    }
    ...
    fn bench_small_mixed_formatting(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(MIXED_FORMATTING);
        });
    }
    ...
    fn bench_small_simple_inline_code(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(SIMPLE_INLINE_CODE);
        });
    }
    ...
    fn bench_small_inline_code_variations(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(INLINE_CODE_VARIATIONS);
        });
    }
    ...
    fn bench_small_inline_code_with_unicode(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(INLINE_CODE_WITH_UNICODE);
        });
    }
    ...
    fn bench_small_links(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(LINKS);
        });
    }
    ...
    fn bench_small_images(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(IMAGES);
        });
    }
    ...
    fn bench_small_metadata_title(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(METADATA_TITLE);
        });
    }
    ...
    fn bench_small_metadata_tags(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(METADATA_TAGS);
        });
    }
    ...
    fn bench_small_metadata_authors(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(METADATA_AUTHORS);
        });
    }
    ...
    fn bench_small_metadata_date(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(METADATA_DATE);
        });
    }
    ...
    fn bench_small_special_characters(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(SPECIAL_CHARACTERS);
        });
    }
    ...
    fn bench_small_unicode_content(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(UNICODE_CONTENT);
        });
    }
    ...
    fn bench_small_emoji_h1_simple(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(EMOJI_H1_SIMPLE);
        });
    }
    ...
    fn bench_small_emoji_h2_simple(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(EMOJI_H2_SIMPLE);
        });
    }
    ...
    fn bench_small_emoji_multiple(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(EMOJI_MULTIPLE);
        });
    }
    ...
    fn bench_medium_multiple_lines(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(MULTIPLE_LINES);
        });
    }
    ...
    fn bench_medium_heading_basic(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(HEADING_BASIC);
        });
    }
    ...
    fn bench_medium_multiple_headings(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(MULTIPLE_HEADINGS);
        });
    }
    ...
    fn bench_medium_all_heading_levels(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(ALL_HEADING_LEVELS);
        });
    }
    ...
    fn bench_medium_unordered_list_simple(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(UNORDERED_LIST_SIMPLE);
        });
    }
    ...
    fn bench_medium_ordered_list_simple(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(ORDERED_LIST_SIMPLE);
        });
    }
    ...
    fn bench_medium_nested_unordered_list(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(NESTED_UNORDERED_LIST);
        });
    }
    ...
    fn bench_medium_nested_ordered_list(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(NESTED_ORDERED_LIST);
        });
    }
    ...
    fn bench_medium_code_block_rust(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(CODE_BLOCK_RUST);
        });
    }
    ...
    fn bench_medium_code_block_bash(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(CODE_BLOCK_BASH);
        });
    }
    ...
    fn bench_medium_code_block_no_language(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(CODE_BLOCK_NO_LANGUAGE);
        });
    }
    ...
    fn bench_medium_empty_code_block(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(EMPTY_CODE_BLOCK);
        });
    }
    ...
    fn bench_medium_mixed_list_types(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(MIXED_LIST_TYPES);
        });
    }
    ...
    fn bench_medium_checkboxes(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(CHECKBOXES);
        });
    }
    ...
    fn bench_medium_formatting_edge_cases(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(FORMATTING_EDGE_CASES);
        });
    }
    ...
    fn bench_medium_nested_formatting(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(NESTED_FORMATTING);
        });
    }
    ...
    fn bench_medium_edge_case_empty_lines(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(EDGE_CASE_EMPTY_LINES);
        });
    }
    ...
    fn bench_medium_edge_case_whitespace_lines(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(EDGE_CASE_WHITESPACE_LINES);
        });
    }
    ...
    fn bench_medium_edge_case_trailing_spaces(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(EDGE_CASE_TRAILING_SPACES);
        });
    }
    ...
    fn bench_medium_emoji_start_middle_end(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(EMOJI_START_MIDDLE_END);
        });
    }
    ...
    fn bench_medium_blog_post_document(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(BLOG_POST_DOCUMENT);
        });
    }
    ...
    fn bench_large_complex_nested_document(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(COMPLEX_NESTED_DOCUMENT);
        });
    }
    ...
    fn bench_large_tutorial_document(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(TUTORIAL_DOCUMENT);
        });
    }
    ...
    fn bench_invalid_malformed_syntax(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(MALFORMED_SYNTAX);
        });
    }
    ...
    fn bench_invalid_unclosed_formatting(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(UNCLOSED_FORMATTING);
        });
    }
    ...
    fn bench_jumbo_real_world_editor(b: &mut Bencher) {
        b.iter(|| {
            let _unused = parse_markdown(REAL_WORLD_EDITOR_CONTENT);
        });
    }
}