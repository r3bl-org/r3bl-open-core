...
//! | [**Stdin**][`stdin`]                    | Read bytes into buffer -> handle using [VT100 input parser] and [paste state machine] to generate [`StdinReaderMessage::Event`]  |
//! | [**Signals**][`signal_hook_mio`]        | Drain signal ([`SIGWINCH`]) and generate [`StdinReaderMessage::Resize`]                                                          |
//! | [**Channel**][`tokio::sync::broadcast`] | Publish [`StdinReaderMessage`] variants to async consumers                                                                       |
//!
//! ## Quick Reference
//!
//! | Item                                             | Description                                                         |
...
//! | [`MioPollerThread::spawn()`]                     | Entry point: spawns the dedicated [`mio_poller`] thread             |
...
//!   its internal [`InputDeviceResourceHandle`], waking the thread to check [`receiver_count()`].
...
//!    | Trigger                    | Behavior                                                                                                      |
//!    | :------------------------- | :------------------------------------------------------------------------------------------------------------ |
//!    | [`stdin`] [`EOF`]          | [`read()`] returns `0` → sends [`StdinReaderMessage::Eof`] → thread exits; see [`EOF`] note below)            |
//!    | I/O error (not [`EINTR`])  | Sends [`StdinReaderMessage::Error`] → thread exits (see [`EINTR`] handling below)                             |
//!    | All receivers dropped      | [`InputDeviceResourceHandle::drop()`] wakes thread → checks `receiver_count() == 0` → exits (~1ms); see below |
//!
...
//! errors, [`EINTR`] is **retried** (not sent as [`StdinReaderMessage::Error`])—the operation simply
...
//!
//! The channel sends [`StdinReaderMessage`] variants to the async side:
//! - [`Event(InputEvent)`] - parsed keyboard/mouse input
//! - [`Resize`] - terminal window changed size
//! - [`StdinReaderMessage::Eof`] - stdin closed
//! - [`StdinReaderMessage::Error`] - I/O error
//!
...
//! [Device Lifecycle]: super::global_input_resource#device-lifecycle
...
//! [`InputDeviceResourceHandle::drop()`]: super::input_device::InputDeviceResourceHandle
//! [`InputDeviceResourceHandle`]: super::input_device::InputDeviceResourceHandle
//! [`InputEvent`]: crate::InputEvent
//! [`LazyLock`]: std::sync::LazyLock
//! [`MioPollerThread::drop()`]: poller_thread::MioPollerThread
//! [`MioPollerThread::spawn()`]: poller_thread::MioPollerThread::spawn
...
//! [`StdinReaderMessage::Eof`]: super::channel_types::StdinReaderMessage::Eof
//! [`StdinReaderMessage::Error`]: super::channel_types::StdinReaderMessage::Error
//! [`StdinReaderMessage::Event`]: super::channel_types::StdinReaderMessage::Event
//! [`StdinReaderMessage::Resize`]: super::channel_types::StdinReaderMessage::Resize
//! [`StdinReaderMessage`]: super::channel_types::StdinReaderMessage
//! [`VEOF`]: https://man7.org/linux/man-pages/man3/termios.3.html
//! [`VT100InputEventIR`]: crate::core::ansi::vt_100_terminal_input_parser::VT100InputEventIR
//! [`allocate()`]: super::global_input_resource::guarded_ops::allocate
