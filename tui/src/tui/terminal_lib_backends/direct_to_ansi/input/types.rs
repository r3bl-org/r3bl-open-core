...
//! Input event types for the DirectToAnsi backend.
//!
//! This module defines the high-level input events that result from parsing
//! ANSI sequences and UTF-8 text. These events are backend-agnostic and can be
//! used by any terminal application.
