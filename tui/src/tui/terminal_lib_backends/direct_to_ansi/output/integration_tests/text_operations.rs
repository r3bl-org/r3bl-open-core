...
//! Integration tests for text painting operations
...
fn test_paint_text_plain_without_style() {
    ...
    let output = execute_text_paint_and_capture(
        text,
        None,
        &mut state,
        &output_device,
    ...
    assert!(
        ...
        "Output should contain the text: {text}"
    );
...
fn test_paint_multiple_text_operations_sequence() {
    ...
    // First text
    let text1 = "First";
    let output1 = execute_text_paint_and_capture(
        text1,
        None,
        &mut state,
        &output_device,
    ...
    assert!(
        output1.contains(text1),
        "First output should contain text: {text1}"
    );
    ...
    let output2 = execute_text_paint_and_capture(
        text2,
        style2,
        &mut state,
        &output_device2,
...
fn test_paint_text_with_special_characters() {
    ...
    assert!(
        output.contains(text),
        "Output should contain special characters: {text}"
    );
...
fn test_paint_text_with_unicode_emoji() {
    ...
    assert!(!output.is_empty(), "Output should not be empty");
    // Note: emoji might be represented differently in ANSI, but the output should contain
    // something
