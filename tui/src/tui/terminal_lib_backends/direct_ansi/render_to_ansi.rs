...
pub trait RenderToAnsi {
    ...
    ///
    /// [`PixelCharRenderer`]: crate::tui::terminal_lib_backends::direct_ansi::pixel_char_renderer::PixelCharRenderer
    /// [`render_line()`]: crate::tui::terminal_lib_backends::direct_ansi::pixel_char_renderer::PixelCharRenderer::render_line
