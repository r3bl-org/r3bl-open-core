...
## Narrow characters in Arrow Symbols, Geometric Shapes, Dingbats block (no need for Nerd Fonts)
...
| `∎`  | U+220E  | End of Proof                          |
| `●`  | U+25CF  | Black Circle                          |
| `␩`  | U+2429  | Symbol For Delete                     |
| `░`  | U+2591  | Light Shade                           |
| `▒`  | U+2592  | Medium Shade                          |
| `▓`  | U+2593  | Dark Shade                            |
| `█`  | U+2588  | Full Block                            |
| `(`  | U+0028  | Left Parenthesis                      |
| `◕`  | U+25D5  | Circle With Upper Left Quadrant White |
| `‿`  | U+203F  | Undertie                              |
